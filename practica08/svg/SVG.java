...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        String s= "<line x1= \"" +(linea.getP1().getX())+"\" y1= \""+(altura-linea.getP1().getY())+
        "\" x2= \"" +(linea.getP2().getX())+ "\" y2=\""+(altura-linea.getP2().getY())+
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        Linea lineaA = new Linea(triangulo.getVerticeA(), triangulo.getVerticeB());
        Linea lineaB = new Linea(triangulo.getVerticeB(), triangulo.getVerticeC());
        Linea lineaC = new Linea(triangulo.getVerticeA(), triangulo.getVerticeC());
